import * as Styles from './searchModal-style'
import { default as React, useCallback, useRef, useState } from 'react'

const SearchModal = (props, children) => {
  ...
  return (
    <React.Fragment>
      <Styles.Modal closed={modalClosed}>
        <Styles.DragLine />
        ...
        <Styles.ModalMenuContainer>
          <Styles.AddButton disabled={false}>선택하기</Styles.AddButton>
